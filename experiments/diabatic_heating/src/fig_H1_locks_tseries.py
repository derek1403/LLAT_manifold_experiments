...
collapse as "the memory of the heating lives in q". But δw = 0 or δz = 0 also
...
def plot(init: str = D.STRONG, style: str = "note", *, ic: str = D.DEFAULT_IC,
    ...
    S.apply()
    series = {fam: D.pv_response_series(str(D.run(fam, tag.format(init=init), ic=ic)),
                                         stat=stat)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", default=None,
                    help="default: figs/<ic>/<stat>/h1_locks_tseries.png")
    a = ap.parse_args()
    out = a.out or D.figs_dir(a.ic, a.stat) / "h1_locks_tseries.png"

...
q-channel-routed. Plotted against the heating sweep on the shared nominal-K axis:
...
def plot(lead_hr: int = 24, style: str = "note"):
    ...
    dq = D.sweep(D.FAMILY["dq_measured"][0], lead_hr)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", default=str(D.FIGS / "h2_dq_sweep.png"))
    a = ap.parse_args()
